        ...
        <div className="bg-background font-body text-on-surface min-h-screen flex flex-col">
            ...
            <main className="app-shell-main app-shell-content page-shell px-6 md:px-8 max-w-7xl mx-auto flex-grow w-full">
                ...
                {isLoading ? (
                    ...
                    <section key={`${activeTab}-${sortBy}-${currentPage}`} className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
                        {books.length > 0 ? (
                            ...
                            <div className="col-span-1 sm:col-span-2 lg:col-span-3 text-center py-20 text-on-surface-variant rounded-2xl border border-outline-variant bg-white">
